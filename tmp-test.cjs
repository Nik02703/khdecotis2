...
const runTest = async (merchantId, saltKey, baseUrl) => {
  ...
  console.log("Testing:", baseUrl, "with config:", merchantId, "saltKey:", saltKey);
  try {
...
runTest("PGTESTPAYUAT86", "96434309-7796-489d-8924-ab56988a6076", "https://api-preprod.phonepe.com/apis/pg-sandbox");
