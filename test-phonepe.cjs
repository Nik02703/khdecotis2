...
async function main() {
  await runTest("M22J0RNBB7A8V_2604032335", "https://api-preprod.phonepe.com/apis/hermes");
  await runTest("M22J0RNBB7A8V_2604032335", "https://api-preprod.phonepe.com/apis/pg-sandbox");
}
